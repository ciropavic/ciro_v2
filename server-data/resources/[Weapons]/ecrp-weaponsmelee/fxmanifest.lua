...
files {
	...
	'weapon_katanas.meta',
	'weapon_bats.meta',
	'weapon_redlightsaber.meta',
	'weapon_bluelightsaber.meta'
	}
...
---------------------------------------------------------------------------
	...
	data_file 'WEAPONINFO_FILE' 'weapon_redlightsaber.meta'
	data_file 'WEAPONINFO_FILE_PATCH' 'weapon_redlightsaber.meta'
	data_file 'WEAPONINFO_FILE' 'weapon_bluelightsaber.meta'
	data_file 'WEAPONINFO_FILE_PATCH' 'weapon_bluelightsaber.meta'