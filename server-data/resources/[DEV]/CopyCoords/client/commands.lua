...
RegisterCommand("copycoords-prefixed2", function(source, args, rawCommand)
    local places = args[1] or nil
    ...
    SendNUIMessage({
        coords = copyCoords("x = :x, y = :y, z = :z", closure),
    })
end)
...
RegisterCommand("copycoords-peds", function(source, args, rawCommand)
    local places = args[1] or nil
    ...
    SendNUIMessage({
        coords = copyCoords("x = :x, y = :y, z = :z, heading = :h", closure),
    })
end)

RegisterCommand("copycoords-shops", function(source, args, rawCommand)
    local places = args[1] or nil
