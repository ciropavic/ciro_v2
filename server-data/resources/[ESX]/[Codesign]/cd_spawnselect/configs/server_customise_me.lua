...
if Config.Framework == 'esx' then
    ESX.RegisterServerCallback('cd_spawnselect:CheckIfNew', function(source, cb)
        local identifier = GetIdentifier(source)
...
RegisterServerEvent('cd_spawnselect:Command')
AddEventHandler('cd_spawnselect:Command', function(action, data)
