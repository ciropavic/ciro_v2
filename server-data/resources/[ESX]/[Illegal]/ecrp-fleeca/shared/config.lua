Config = {}
Config.hacktime = 1000 -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
Config.maxcash = 4000 -- maximum amount of cash a pile can hold
Config.mincash = 2000 -- minimum amount of cash a pile holds
Config.black = true -- enable this if you want blackmoney as a reward
Config.cooldown = 600 -- amount of time to do the heist again in seconds (15min)
