        ...
        if item >= 1 then
            if not UTK.Banks[bank].onaction == true then
                if (os.time() - UTK.cooldown) > UTK.Banks[bank].lastrobbed then
                    ...
                    TriggerClientEvent("utk_fh:outcome", _source, false,
                        "This bank recently robbed. You need to wait " ..
            ...
            TriggerClientEvent("utk_fh:outcome", _source, false, "You don't have a green laptop.")
        end
    else
