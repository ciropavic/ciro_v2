...
local parkingZones = ComboZone:Create({apartmentsParking, pinkCageParking, casinoParking, mirrorParking, paletoParking,
                                       uwuParking1, uwuParking2, pierParking, sandyParking, mrpd}, {
    -- debugPoly = true
})
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
        key7709 = exports.ox_inventory:Search('count', '7709_key')
    end
end)
