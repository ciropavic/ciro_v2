...
RegisterServerEvent('onyx:updatePickedVehTable')
AddEventHandler('onyx:updatePickedVehTable', function(plate)
    local _source = source
    local vehPlate = plate

    TriggerClientEvent('onyx:returnPickedVehTable', -1, vehPlate)
end)
...
RegisterServerEvent('onyx:slimjim')
AddEventHandler('onyx:slimjim', function(plate)
    TriggerClientEvent('onyx:beginHotwire', source, plate)
end)