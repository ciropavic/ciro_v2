...
function fillSQLSearch(results, field) {
  ...
  if (field == 'profiles') {
    ...
    for (const [key, value] of Object.entries(results)) {
      ...
      var base = '      <div class="clearfix colelem box scale-up-center user" onclick="openProfile(\'' + value.identifier + '\')" id="' + value.identifier.replace(":", "-") + '""><!-- group -->' +
        '       <div class="grpelem" id="u1258" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>' +
        '       <div class="grpelem" id="u1259" style="background: url(' + url + '); background-size: cover;" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>' +
        '       <div class="clearfix grpelem" id="u1260-4" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- content -->' +
        '        <p>' + value.firstname + ' ' + value.lastname + '</p>' +
  ...
  if (field == 'users') {
    ...
    for (const [key, value] of Object.entries(results)) {
      ...
      var base = '      <div class="clearfix colelem box scale-up-center user" onclick="chooseToAdd(\'' + value.identifier + '\')" id="' + value.identifier.replace(":", "-") + '""><!-- group -->' +
        '       <div class="grpelem" id="u1258" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>' +
        '       <div class="grpelem" id="u1259" style="background: url(' + url + '); background-size: cover;" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>' +
        '       <div class="clearfix grpelem" id="u1260-4" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- content -->' +
        '        <p>' + value.firstname + ' ' + value.lastname + '</p>' +
...
'    <p>'+vehColors[JSON.parse(v.vehicle)["color1"]]+'</p>'+
'   </div>'+
...
function openProfiles() {
  ...
  base = base + '     </div>' +
    ...
    '      <p>HEIGHT</p>' +
    '     </div>' +
    '     <input class="colelem" type="number" readonly="readonly" id="height" data-sizePolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></input>' +
...
window.addEventListener('message', function(event) {
  ...
  if (edata.type == "open") {
     ...
     users = edata.users;
      ...
      if (users[edata.identifier] == null) {
    ...
    permissions = users[identifier].permissions;


    for (const [key, value] of Object.entries(edata.instantadmins)) {
      if (identifier == key && value == true) {
