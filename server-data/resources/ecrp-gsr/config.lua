Config = {
    ...
    EnableCleanGSR = false, -- Set this to false if you dont want people to be able to clean gsr off them

    GSRAutoClean = 900, -- (IN SECONDS) Ammount Of Time Before GSR Auto Cleans [Default Is 15 Minutes]
    GSRTestDistance = 2, -- Maximum Distance That You Can Be To Test For GSR ***I Recomend Leaving This Low***
