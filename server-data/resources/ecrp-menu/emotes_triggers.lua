...
RegisterNetEvent('AnimSet:Hurry2');
AddEventHandler('AnimSet:Hurry2', function()
    RequestAnimSet("move_m@hurry@b")
    while not HasAnimSetLoaded("move_m@hurry@b") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@hurry@b", true)
    AnimSet = "move_m@hurry@b";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)

RegisterNetEvent('AnimSet:Hurry3');
AddEventHandler('AnimSet:Hurry3', function()
    RequestAnimSet("move_m@hurry@c")
    while not HasAnimSetLoaded("move_m@hurry@c") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@hurry@c", true)
    AnimSet = "move_m@hurry@c";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)

RegisterNetEvent('AnimSet:Hurry4');
AddEventHandler('AnimSet:Hurry4', function()
    RequestAnimSet("move_m@hurry_butch@a")
    while not HasAnimSetLoaded("move_m@hurry_butch@a") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@hurry_butch@a", true)
    AnimSet = "move_m@hurry_butch@a";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)

RegisterNetEvent('AnimSet:Hurry5');
AddEventHandler('AnimSet:Hurry5', function()
    RequestAnimSet("move_m@hurry_butch@b")
    while not HasAnimSetLoaded("move_m@hurry_butch@b") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@hurry_butch@b", true)
    AnimSet = "move_m@hurry_butch@b";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)

RegisterNetEvent('AnimSet:Hurry6');
AddEventHandler('AnimSet:Hurry6', function()
    RequestAnimSet("move_m@hurry_butch@c")
    while not HasAnimSetLoaded("move_m@hurry_butch@c") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@hurry_butch@c", true)
    AnimSet = "move_m@hurry_butch@c";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)
...
AddEventHandler('AnimSet:Business2', function()
    RequestAnimSet("move_m@business@b")
    while not HasAnimSetLoaded("move_m@business@b") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@business@b", true)
    AnimSet = "move_m@business@b";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)

RegisterNetEvent('AnimSet:Business3');
AddEventHandler('AnimSet:Business3', function()
    RequestAnimSet("move_m@business@c")
    while not HasAnimSetLoaded("move_m@business@c") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@business@c", true)
    AnimSet = "move_m@business@c";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)
...
RegisterNetEvent('AnimSet:Brave2');
AddEventHandler('AnimSet:Brave2', function()
    RequestAnimSet("move_m@brave@b")
    while not HasAnimSetLoaded("move_m@brave@b") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@brave@b", true)
    AnimSet = "move_m@brave@b";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)
...
RegisterNetEvent('AnimSet:Sad2');
AddEventHandler('AnimSet:Sad2', function()
    RequestAnimSet("move_m@sad@b")
    while not HasAnimSetLoaded("move_m@sad@b") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@sad@b", true)
    AnimSet = "move_m@sad@b";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)

RegisterNetEvent('AnimSet:Sad3');
AddEventHandler('AnimSet:Sad3', function()
    RequestAnimSet("move_m@sad@c")
    while not HasAnimSetLoaded("move_m@sad@c") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@sad@c", true)
    AnimSet = "move_m@sad@c";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)
...
RegisterNetEvent('AnimSet:Swagger2');
AddEventHandler('AnimSet:Swagger2', function()
    RequestAnimSet("move_m@swagger@b")
    while not HasAnimSetLoaded("move_m@swagger@b") do Citizen.Wait(0) end
    SetPedMovementClipset(PlayerPedId(), "move_m@swagger@b", true)
    AnimSet = "move_m@swagger@b";
    TriggerServerEvent("police:setAnimData", AnimSet)
end)
