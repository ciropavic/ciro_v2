...
Config.RagdollWhenShot = false -- enables player ragdoll (fall into ground) when shot.
...
Config.Crouch = true -- true to enable crouching

Config.Pause = true -- Disable pause menu with "P" key

Config.Shuffle = true -- true to disable seat shuffling

Config.AirControl = true -- true to disable vehicle air controls

Config.Brakelights = true -- true to enable Brakelights when vehicle is stopped

Config.RollOver = false -- true disable flipping over a flipped vehicle with A and D
...
Config.JumpSpam = {
  Enable = true, -- true to prevent spam jumping by ragdolling player
  Chance = 0.3 -- Change to ragdoll player
}
